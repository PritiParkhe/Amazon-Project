    ...
    <Container>
     ...
     <Main>
        <FormContainer>
            <InputContainer>
                <p>Full Name</p>
                <input type='text' placeholder='Jhon Smith' onChange={(e) => 
            ...
            <InputContainer>
                ...
                <input type='text' onChange={(e) => 
                    setFlat(e.target.value)} value={flat}/>
            </InputContainer>
            <InputContainer>
                <p>Area, Colony, Street</p>
                <input type='text' onChange={(e) => 
                    setArea(e.target.value)} value={area}/>
            </InputContainer>
            <InputContainer>
                <p>LandMark</p>
                <input type='text' onChange={(e) => 
                    setLandMark(e.target.value)} value={landmark}/>
            </InputContainer>
            <InputContainer>
                <p>Town/City</p>
                <input type='text' onChange={(e) => 
